...
#train_model(model3, DATASET_INDEX, dataset_prefix='har', epochs=2, batch_size=128)
    ...
    #print('>%.3f' % acc)
    #scores.append(acc)
    model1.load_weights('./weights/hhar_1_weights.h5')
    ...
    #print('>%.3f' % acc2)
    model2.load_weights('./weights/hhar_2_weights.h5')
    #scores.append(acc2)
    members.append(model2)
    model3 = generate_model_4()
    model3.load_weights('./weights/hhar_3_weights.h5')
    #scores.append(acc3)
...
# evaluate model on test set
    yhat1 = stacked_prediction(members, model, X_test)
    print(yhat1.shape)
    print(yhat1)
