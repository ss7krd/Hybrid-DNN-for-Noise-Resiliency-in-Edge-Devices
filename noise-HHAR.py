...
#train_model(model3, DATASET_INDEX, dataset_prefix='har', epochs=2, batch_size=128)
    ...
    save('HHAR-train_X_1_g.npy', X_train)
    ...
    save('HHAR-test_X_1_g.npy', X_test)
    X_train = []
    X_test = []
    ...
    save('HHAR-train_X_1_s.npy', X_train)
    ...
    save('HHAR-test_X_1_s.npy', X_test)
    ...
    for i in range (100):
        ...
        if np.mod (id1,2) == 0:
             ...
             X_train [id1,id2,id3] = X_train[id1,id2,id3] + s[i]
    save('HHAR-train_X_1_c.npy', X_train)
    ...
    for i in range (50):
        ...
        if np.mod (id1,2) == 0:
             ...
             X_test [id1,id2,id3] = X_test[id1,id2,id3] + s[i]
    save('HHAR-test_X_1_c.npy', X_test)